...
public class driver {
	...
	public static void createFirstLayerMapReduceJob (String dt,String inputFile,String outputFolder) throws Exception{
		...
		job.setJarByClass(topkproducts.driver.class);
		job.setMapperClass(topkproducts.mapper1.class);
		job.setReducerClass(topkproducts.reducer1.class);
	...
	public static void createSecondLayerMapReduceJob(String topK, String inputFolder,String outputFolder) throws Exception{
		...
		Job job = Job.getInstance(conf, "JobName");
		job.setJarByClass(topkproducts.driver.class);
		job.setMapperClass(topkproducts.mapper2.class);
		job.setReducerClass(topkproducts.reducer2.class);
